  ...
  <div className="ProjectsDisplay">
    <div className="ProjectHolder One">
      ...
      <div className="ProjectContentHolder">
        ...
        <div className="ProjectInformationHolder">
          ...
          <p className="textForProjects">Amount Of Time Taken To Complete : <i>3 Days</i> </p>
          ...
          <a className="atagForButton" href={projects[0].projectWebsite} target="_blank"><button className="viewCodeOrLive">View Live</button></a>
        </div>
      </div>
    </div>
    ...
    <div className="ProjectHolder Two">
      ...
      <div className="ProjectInformationHolder">
          ...
          <p className="textForProjects">Amount Of Time Taken To Complete : <i>2 Weeks</i> </p>
    ...
    <div className="ProjectHolder Three">
      ...
      <div className="ProjectContentHolder">
        ...
        <div className="ProjectInformationHolder">
          ...
          <a className="atagForButton" href={projects[2].projectWebsite} target="_blank"><button className="viewCodeOrLive">View Live</button></a>
        </div>
      </div>
    </div>
